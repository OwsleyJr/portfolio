  ...
  return (
    <div className="flex flex-col items-start justify-center pt-16 mx-auto w-11/12 sm:w-2/3 sm:pt-24">
      <div className="bg-[#11212c]">
        ...
        <div>
          <p className="mt-3 sm:mt-2 text-xl font-black leading-7 text-cyan-500 cursor-default sm:text-xl md:text-2xl lg:text-2xl xl:text-3xl 2xl:text-4xl md:leading-10">
