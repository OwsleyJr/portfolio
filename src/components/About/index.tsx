  ...
  return (
    <div className="flex flex-col justify-center pt-16 mx-auto w-11/12 sm:w-2/3 sm:pt-24">
      <div className="bg-[#11212c]">
        ...
        <div>
          <p className="mt-2 text-3xl font-black leading-8 text-cyan-500 cursor-default sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl 2xl:text-5xl md:leading-10">
            I am a Software Engineer who lives and works in South Florida.
          </p>
        </div>

        <div>
          <p className="mt-3 sm:mt-2 text-xl font-black leading-6 text-cyan-500 cursor-default sm:text-xl md:text-2xl lg:text-2xl xl:text-3xl 2xl:text-4xl md:leading-10">
