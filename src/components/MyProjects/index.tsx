...
const MyProjects: React.FC = () => {
  return (
    <div className="flex flex-col items-center mx-auto pt-10 sm:py-24">
              ...
              <div className="bg-contain bg-js-image rounded-lg">
                <div className="flex flex-col justify-between w-full h-full px-4 py-5 mb-6 border-2 border-red-500 rounded-lg shadow-lg backdrop-brightness-50 backdrop-blur-sm shadow-black">
                  <div>
                    ...
                    >
                      <h4 className="z-40 mb-3 text-3xl font-extrabold text-red-500 transition duration-300 ease-in-out delay-150 hover:-translate-y-1 hover:scale-102">
                        JSON Parser
                      </h4>
                    </a>
                    <p className="font-bold text-gray-100 cursor-default sm:text-lg">
